...
import { ShapeType, PolygonParams, ShapeEventType } from '../types/shape.types.js';
...
export class Polygon extends BaseShape {
   ...
   */
  public get vertices(): readonly number[] {
   ...
   */
  public async scale(factor: number): Promise<void> {
   ...
   */
  public async update(params: Partial<PolygonParams>): Promise<void> {
