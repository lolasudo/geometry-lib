import { Rectangle, Circle, Triangle, Polygon, ShapeFactory, ShapeUtils, ShapeEventType } from './index.js';
async function example() {
    ...
    // Подписка на события
    rectangle.addEventListener(ShapeEventType.CALCULATE, (event) => {
